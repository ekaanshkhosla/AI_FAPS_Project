...
image_dir_train = os.path.join(working_folder, "Augmented_data/100-200_SD_img2img")

train_df = pd.read_csv('data_labels/augmentation_img2img/100_200_augmented.csv')
...
for i in range(0, 10):
    ...
    num_epochs = 5
    best_val_f1 = 0
    best_model_path = "Efficient_V2_optuna_winding_large_testing_aug_100-200_best_model.pth"
...
pd.DataFrame(all_scores).to_csv("Efficient_V2_optuna_winding_large_testing_aug_100-200.csv")