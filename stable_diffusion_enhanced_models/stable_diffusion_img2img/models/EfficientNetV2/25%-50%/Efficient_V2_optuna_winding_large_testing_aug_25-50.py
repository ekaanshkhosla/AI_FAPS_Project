...
best_hyperparameters = {
    ...
    'fc_units': 256, 
    'dropout_rate': 0.5,  
    'layer_freeze': 'features.2.6.block.1.1.bias',
    'num_classes': 3  
}
...
for i in range(0, 10):
    ...
    num_epochs = 5
    best_val_f1 = 0
    best_model_path = "Efficient_V2_optuna_winding_large_testing_aug_25-50_best_model.pth"
...
pd.DataFrame(all_scores).to_csv("Efficient_V2_optuna_winding_large_testing_aug_25-50.csv")