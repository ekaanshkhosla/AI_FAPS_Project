...
for i in range(0, 5):
    ...
    num_epochs = 5
    best_val_f1 = 0
    best_model_path = "DinoV2_optuna_winding_large_testing_ten_aug_100-200_best_model.pth"
...
pd.DataFrame(all_scores).to_csv("DinoV2_optuna_winding_large_testing_ten_aug_100-200.csv")