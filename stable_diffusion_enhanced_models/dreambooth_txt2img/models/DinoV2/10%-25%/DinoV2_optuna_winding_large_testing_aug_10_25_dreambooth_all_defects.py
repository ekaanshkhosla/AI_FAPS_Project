...
for i in range(0, 10):
    ...
    num_epochs = 5
    best_val_f1 = 0
    best_model_path = "DinoV2_optuna_winding_large_testing_aug_10_25_dreambooth_all_defects_best_model.pth"
...
pd.DataFrame(all_scores).to_csv("DinoV2_optuna_winding_large_testing_aug_10_25_dreambooth_all_defects.csv")