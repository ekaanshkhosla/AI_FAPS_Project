...
for i in range(0, 10):
    ...
    num_epochs = 5
    best_val_f1 = 0
    best_model_path = "Efficient_V2_optuna_winding_large_testing_best_model.pth"
...
pd.DataFrame(all_scores).to_csv("Efficient_V2_optuna_winding_large_testing_full_data.csv")