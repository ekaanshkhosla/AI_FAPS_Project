...
class CustomDINONormModel(nn.Module):
    def __init__(self, dino_model):
        ...
        self.freeze_layers('dino_model.blocks.7.ls2.gamma')
...
for i in range(0, 10):
    ...
    num_epochs = 5
    best_val_f1 = 0
    best_model_path = "DinoV2_optuna_winding_large_ten_freezing_testing.pth"
...
pd.DataFrame(all_scores).to_csv("DinoV2_optuna_winding_large_ten_freezing_testing.csv")